...
if u enhance den make it full of use...


<span>             |<span>
---                |---
**Submitted On**   |
**By**             |[Bimal Kumar Barik](https://github.com/Planet-Source-Code/PSCIndex/blob/master/ByAuthor/bimal-kumar-barik.md)
**Level**          |Intermediate
...
**Archive File**   |[](https://github.com/Planet-Source-Code/bimal-kumar-barik-hosptal-database-management-system__3-11315/archive/master.zip)

### API Declarations

if u want to do in c den just modify it...
...
";
 cout<<"
	Developer        : Bimal Kumar Barik "<<"
";
 cout<<"	Programming Language   : C++ and oops"<<"
";
...
";
 cout<<"
	Send your comments to : bimal.nitt@gmail.com ."<<"
";
 cout<<"
	Thank You for trying this program. "<<"
";
